...
export async function runAIAssessment({ profile, ruleResult, photos, verification }) {
  ...
  const profileText = JSON.stringify({
    ...
    license: { status: profile.licStatus },
    driving: { movingViolations: profile.violations, atFaultAccidents: profile.accidents, duiDwi: profile.dui },
    insurance: { active: profile.hasIns === "yes" },
  }, null, 2);
